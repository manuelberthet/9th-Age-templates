...
\usepackage{graphbox}		% To allow picture centering in tabular environnement.
...
\newcommand{\startarmymagicitems}{\newpage\armytitle{\labels@magicitems}\begin{multicols}{2}\raggedcolumns}
\newcommand{\closearmymagicitems}{\end{multicols}}
...
% Special rules entry.
\newcommand{\specialrules}[1]{\unitentry{#1}{\textit{\labels@specialrules :}\expandafter\ruleslist\expandafter{#1}.}}
\newcommand{\commonspecialrules}[2]{\unitentry{#2}{\textit{#1:}\expandafter\ruleslist\expandafter{#2}.}}
...
% Magic entry.
\newcommand{\magic}[2]{\unitentry{#2}{\textit{\labels@magic : }\ifdefempty{#1}{}{\magiclevel{#1}. }\labels@pathsused\expandafter\pathslist\expandafter{#2}.}}
...
% Equipment entry.
\newcommand{\equipment}[1]{\unitentry{#1}{\textit{\labels@equipment :}\expandafter\equipmentlist\expandafter{#1}.}}
...
\define@key{commandgroup}{veteranbannerallowance}  	  {\def\commandgroup@veteranbannerallowance{#1}}
...
\newcommand{\defcommandgroup}{%
	\setkeys{commandgroup}{restriction=,
	                       ...
	                       championrestriction=, banner=, bannerallowance=, veteranbannerallowance=, 
		...
		\begin{description}[leftmargin=0.3cm, labelindent=0cm, labelsep=0cm, itemsep=0cm, parsep=0cm]%
			...
			\ifdefempty{\commandgroup@banner}{}{% We have a banner!
				\item \hspace*{-0.04cm}\option{\labels@standardbearer%
					...
					\ifdefempty{\commandgroup@veteranbannerallowance}{}{\par\option[\upto]{\hspace*{0.3cm}- \labels@veteranbannerallowance}{\commandgroup@veteranbannerallowance}}%
...
\newcommand{\defunit}{
	\setkeys{unit}{%
		name=, profile=, cost=, invocation=, costpermodel=, maxmodels=, type=, unitsize=, basesize=, commonspecialrules=, commontype=, specialrules=, magiclevel=, magicpaths=, equipment=, unitequipment=, options=, mounts=, commandgroup=, unitrules=, additional=%
	}%
	\setkeys{unit}%
}
...
\newcommand{\showunit}[1]{
	...
	\expandafter\ifnumequal\expandafter{\unit@unitsize}{1}{% single model
		% Can you add model to this single model ?
		\expandafter\ifblank\expandafter{\unit@maxmodels}{% no		
			{\hspace*{0.25cm}\large\textbf{Single} model}%
		}{% yes
			{\hspace*{0.25cm}\large \textbf{1} model, up to \textbf{\unit@maxmodels{}}} models \hfill\textbf{\unit@costpermodel{}} pts/model\hspace*{0.1cm}%
		}%
	}{% not single model					
		{\hspace*{0.25cm}\large\textbf{\unit@unitsize} models\expandafter\ifblank\expandafter{\unit@maxmodels}{}{, up to \textbf{\unit@maxmodels{}}} models \hfill\textbf{\unit@costpermodel{}} pts/model\hspace*{0.1cm}}%
	}%
	\begin{mdframed}
