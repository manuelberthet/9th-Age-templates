...
\newcommand{\showunit}[1]{
	...
	\expandafter\ifnumequal\expandafter{\unit@unitsize}{1}{%single model
		...
		{\hspace*{0.25cm}\large\textbf{\unit@unitsize} models\expandafter\ifblank\expandafter{\unit@additionalmodels}{}{ and up to \textbf{\unit@additionalmodels{}}}  additional models \hfill\textbf{\unit@costpermodel{}} pts/model\hspace*{0.1cm}}%
	}%
	\begin{mdframed}
