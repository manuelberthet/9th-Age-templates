...
\newcommand{\profiledtbfillcarac}[1]{%
	...
	\forlistloop{\stepcounter{multiprofilecounter}\profileanalyze}{\locallists@profileslist}%
	\DTLnewdbentry{profiles}{multipleprofile}{\themultiprofilecounter}
}
\newcommand{\profileanalyze}[1]{%
	\splitatinf{#1}\local@unitname\local@unitprofile%
	\ifnumequal{\themultiprofilecounter}{1}{% then this is the first profile of a multiprofile or a single profile
		\DTLnewdbentry{profiles}{profilename}{\local@unitname}%
		\DTLnewdbentry{profiles}{caraclist}{\expandafter\caraclist\expandafter{\local@unitprofile}}% List of characteristics separated by &
	}{% Else it is another profile of a multiprofile
		\DTLnewdbentry{profiles}{profilename\themultiprofilecounter}{\local@unitname}%
		\DTLnewdbentry{profiles}{caraclist\themultiprofilecounter}{\expandafter\caraclist\expandafter{\local@unitprofile}}% List of characteristics separated by &
	}%
}
...
\newcommand{\quickrefsheettitle}{\clearpage\armytitle{\labels@quickrefsheet}}
...
\newcommand{\showunit}[1]{
	...
	\begin{multicols}{2}
		...
		\commonspecialrules{\unit@commontype}{\unit@commonspecialrules}
		
		\specialrules{\unit@specialrules}
		
		\magic{\unit@magiclevel}{\unit@magicpaths}
