...
\newcommand{\QRSstarttab}[1]{%
	...
	& \textbf{#1} & \textbf{\labels@M} & \textbf{\labels@WS} & \textbf{\labels@BS} & \textbf{\labels@S} & \textbf{\labels@T} & \textbf{\labels@W} & \textbf{\labels@I} & \textbf{\labels@A} & \textbf{\labels@Ld}%
}%
...
\newcommand{\QRSprintline}[4]{%
	...
	\DTLifeq*{\rowcategory}{\labels@lords}{\includegraphics[align=c, width=\QRSlogowidth]{../Layout/pics/logo_lord.png}}{}%
	\DTLifeq*{\rowcategory}{\labels@heroes}{\includegraphics[align=c, width=\QRSlogowidth]{../Layout/pics/logo_hero.png}}{}%
	\DTLifeq*{\rowcategory}{\labels@coreunits}{\includegraphics[align=c, width=\QRSlogowidth]{../Layout/pics/logo_core.png}}{}%
	\DTLifeq*{\rowcategory}{\labels@specialunits}{\includegraphics[align=c, width=\QRSlogowidth]{../Layout/pics/logo_special.png}}{}%
	\DTLifeq*{\rowcategory}{\labels@rareunits}{\includegraphics[align=c, width=\QRSlogowidth]{../Layout/pics/logo_rare.png}}{}%
	\DTLifeq*{\rowcategory}{\labels@mounts}{\includegraphics[align=c, width=\QRSlogowidth]{../Layout/pics/logo_mount.png}}{}%
	&%
