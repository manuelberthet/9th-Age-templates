...
\newcommand{\leadersoftheundead}{\specialrule{Maîtres de la Non-Vie}\xspace}
\newcommand{\necroticnexus}{\specialrule{Lien Nécrotique}\xspace}
\newcommand{\ashestoashes}{\specialrule{Poussière Tu Redeviendras Poussière}\xspace}
\newcommand{\hunger}[1]{\specialrule{Soif Insatiable\ifblank{#1}{}{ (#1+)}}\xspace}
\newcommand{\otherworldlyscream}[1]{\specialrule{Cri d'Outre-Monde\ifblank{#1}{}{ (#1)}}\xspace}
\newcommand{\awaken}[1]{\specialrule{Sombre Réveil\ifblank{#1}{}{ (#1)}}\xspace}
\newcommand{\invocation}[1]{\specialrule{Invocation\ifblank{#1}{}{ (#1)}}\xspace}
\newcommand{\reaper}{\specialrule{Moissonneur}\xspace}
\newcommand{\vampiric}{\specialrule{Vampirique}\xspace}
\newcommand{\supernaturalaura}{\specialrule{Aura Surnaturelle}\xspace}
\newcommand{\anticrumbleaura}{\specialrule{Aura de Stabilité}\xspace}
\newcommand{\bloodpower}{\specialrule{Pouvoir Dynastique}\xspace}
\newcommand{\bloodpowers}{\specialrule{Pouvoirs Dynastiques}\xspace}
\newcommand{\thinbloodpower}{\specialrule{Pouvoir Dynastique Mineur}\xspace}
\newcommand{\thinbloodpowers}{\specialrule{Pouvoirs Dynastiques Mineurs}\xspace}
\newcommand{\thickbloodpower}{\specialrule{Pouvoir Dynastique Majeur}\xspace}
\newcommand{\thickbloodpowers}{\specialrule{Pouvoirs Dynastiques Majeurs}\xspace}
\newcommand{\bloodline}{\specialrule{Dynastie}\xspace}
\newcommand{\bloodlines}{\specialrule{Dynasties}\xspace}
\newcommand{\bloodlineunit}[1]{\specialrule{Unité Dynastique\ifblank{#1}{}{ (#1)}}\xspace}
\newcommand{\bloodlineunits}[1]{\specialrule{Unités Dynastique\ifblank{#1}{}{ (#1)}}\xspace}
\newcommand{\blooddrakebloodline}{\specialrule{Dynastie des Dragons de Sang}\xspace}
\newcommand{\blooddrakes}{\specialrule{Dragons de Sang}\xspace}
\newcommand{\blooddrake}{\specialrule{Dragon de Sang}\xspace}
\newcommand{\strigoibloodline}{\specialrule{Dynastie des Stryges}\xspace}
\newcommand{\strigois}{\specialrule{Stryges}\xspace}
\newcommand{\strigoi}{\specialrule{Stryge}\xspace}
\newcommand{\voncastelsteinbloodline}{\specialrule{Dynastie des Von Castelstein}\xspace}
...
\def\endlesshorde{\specialrule{Horde sans Fin}\xspace} % \def necessary: a \newcommand name can't start with "end"
...
\armynewsection{Dynasties Vampiriques}
